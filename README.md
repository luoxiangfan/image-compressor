...
> JavaScript image compressor(typescript support).Based on [fengyuanchen/compressorjs](https://github.com/fengyuanchen/compressorjs)
...
import Compressor from 'js-image-compress';
